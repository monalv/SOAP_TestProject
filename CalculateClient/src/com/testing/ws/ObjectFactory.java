 ...
 * generated in the com.testing.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Divide_QNAME = new QName("http://ws.testing.com/", "Divide");
    private final static QName _Subtract_QNAME = new QName("http://ws.testing.com/", "Subtract");
    private final static QName _Add_QNAME = new QName("http://ws.testing.com/", "Add");
    private final static QName _DivideResponse_QNAME = new QName("http://ws.testing.com/", "DivideResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ws.testing.com/", "MultiplyResponse");
    private final static QName _Multiply_QNAME = new QName("http://ws.testing.com/", "Multiply");
    private final static QName _AddResponse_QNAME = new QName("http://ws.testing.com/", "AddResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://ws.testing.com/", "SubtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.testing.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "Divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "Subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "Add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "DivideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "MultiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "Multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "AddResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.testing.com/", name = "SubtractResponse")
